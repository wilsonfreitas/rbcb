...
test_that('should create urls', {
  ...
  expect_equal(series_url(1, start_date='2016-01-01'), c('1' = url))
  ...
  expect_equal(series_url(1, end_date='2016-01-01'), c('1' = url))

  expect_equal(series_url(1, start_date='2016-01-01', end_date='2016-12-31'),
               c('1' = 'http://api.bcb.gov.br/dados/serie/bcdata.sgs.1/dados?formato=json&dataInicial=01%2F01%2F2016&dataFinal=31%2F12%2F2016'))
  expect_equal(series_url(1, last = 1),
               c('1' = 'http://api.bcb.gov.br/dados/serie/bcdata.sgs.1/dados/ultimos/1?formato=json'))
